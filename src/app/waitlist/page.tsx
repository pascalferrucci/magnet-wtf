    ...
    <div style={{
      ...
      <div style={{ padding: '8px 10px 4px', display: 'flex', alignItems: 'center', gap: 8 }}>
        <div style={{
          ...
          fontSize: 13, color: '#fff', fontWeight: 900, letterSpacing: -0.5,
        }}>MB</div>
        <div>
      ...
      <div style={{ margin: '4px 8px', borderRadius: 11, overflow: 'hidden', background: '#e8e3da', height: 90, display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(135deg, #c8b89a 0%, #8a7a6a 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 30 }}>
          👗
        </div>
    ...
    <div style={{ background: '#faf9f7', minHeight: '100vh', fontFamily: 'Arial, Helvetica, sans-serif', color: '#1a1a1a' }}>
      ...
      <nav style={{ padding: '18px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid rgba(0,0,0,0.06)', background: 'rgba(250,249,247,0.9)', backdropFilter: 'blur(8px)', position: 'sticky', top: 0, zIndex: 50 }}>
        ...
        <a href="/login" style={{ fontSize: 13, color: '#666', textDecoration: 'none' }}>
          Already have a code? <span style={{ color: '#37bce4', fontWeight: 600 }}>Sign in →</span>
        </a>
      </nav>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 32px 60px', textAlign: 'center' }}>
        ...
        {!submitted ? (
          <div style={{ display: 'flex', gap: 10, maxWidth: 440, margin: '0 auto', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <button
              ...
              style={{
                ...
                opacity: loading || !email.trim() ? 0.55 : 1, transition: 'opacity 0.2s',
              }}
            >
          ...
          <div style={{ maxWidth: 440, margin: '0 auto', background: '#fff', borderRadius: 16, padding: '24px 28px', border: '1px solid rgba(0,0,0,0.06)', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
            ...
            <a href="/" style={{ display: 'inline-block', marginTop: 16, fontSize: 13, color: '#37bce4', fontWeight: 600, textDecoration: 'none' }}>← Back to home</a>
          </div>
        )}
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 20 }}>
            {[
              {
                emoji: '🎨',
                title: 'Your latest drop',
                desc: 'New artwork, new product, new video — pin it at the top so nobody misses it.',
                accent: '#e63187',
              },
              {
                emoji: '📺',
                title: 'Your channel, your clips',
                desc: 'Link your YouTube, TikTok, Twitch in one widget. Your fans watch without leaving your page.',
                accent: '#37bce4',
              },
              {
                emoji: '🛍️',
                title: 'Your shop, your links',
                desc: 'Add Shopify, Gumroad, or any URL. Turn visits into clicks into sales.',
                accent: '#66bb93',
              },
              {
                emoji: '📅',
                title: 'Your agenda',
                desc: 'Live sessions, workshops, events — your next date is always one tap away.',
                accent: '#a78bfa',
              },
      ...
      <section style={{ padding: '72px 32px', maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 24, maxWidth: 860, margin: '0 auto' }}>
          {[
            {
              step: '01',
              title: 'Claim your magnet link',
              desc: 'magnet.wtf/yourname is yours. Short, memorable, easy to drop anywhere.',
              color: '#e63187',
            },
            {
              step: '02',
              title: 'Add whatever you want',
              desc: 'Videos, links, a shop, a newsletter, your latest posts. Drag, drop, done.',
              color: '#37bce4',
            },
            {
              step: '03',
              title: 'Watch your audience find you',
              desc: 'Share one link everywhere. They get everything. You get the analytics.',
              color: '#66bb93',
            },
          ...
          {!submitted ? (
            <div style={{ display: 'flex', gap: 10, maxWidth: 420, margin: '0 auto', flexWrap: 'wrap', justifyContent: 'center' }}>
              <input
                ...
                onKeyDown={e => e.key === 'Enter' && handleSubmit()}
                style={{
                  flex: 1, minWidth: 200, padding: '13px 16px', borderRadius: 14,
                  border: '1.5px solid rgba(0,0,0,0.12)', background: '#fff',
